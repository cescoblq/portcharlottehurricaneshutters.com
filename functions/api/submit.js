...
//
// TODO (see TODO-DEPLOY.md): the n8n webhook "niches-leads-hurricane-shutters-portcharlotte-us"
// does not exist yet — it needs to be created in n8n before this relay will actually deliver leads.
export async function onRequestPost({ request }) {
  const body = await request.text();

  const upstream = await fetch("https://n8n.byteblast.ovh/webhook/niches-leads-hurricane-shutters-portcharlotte-us", {
    method: "POST",
